class RatingsController < ApplicationController
  ...
  def destroy
    @rating.destroy
    respond_to do |format|
      format.html { redirect_to user_ratings_path(current_user), notice: 'Rating was successfully destroyed.' }
  ...
  private
    ...
    def rating_params
      params.require(:rating).permit(:name, :score, :description, :user_id)
    end
end
